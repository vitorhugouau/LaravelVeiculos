...
@section('hero')
    <div class="hero-section">
        <div class="hero-content">
            <h1 class="hero-title">
                <i class="fas fa-plus-circle"></i> Nova Cor
            </h1>
            <p class="hero-subtitle">Adicione uma nova cor ao sistema</p>
        </div>
    </div>
@endsection
...
@section('content')
    ...
    <div class="admin-card">
        <div class="card-body">
            <form action="{{ route('admin.colors.store') }}" method="POST" class="admin-form">
                @csrf
