...
@section('hero')
    <div class="hero-section">
        <div class="hero-content">
            ...
            <p class="hero-subtitle">Atualize as informações do modelo</p>
        </div>
    </div>
@endsection
...
@section('content')
    <div class="page-header">
        <h2 class="page-title">
            <i class="fas fa-list"></i> Editar Modelo
        </h2>
    ...
    <div class="admin-card">
        <div class="card-body">
            <form action="{{ route('admin.models.update', $model->id) }}" method="POST" class="admin-form">
                @csrf
                @method('PUT')
