...
@section('hero')
    <div class="hero-section">
        <div class="hero-content">
            ...
            <p class="hero-subtitle">Atualize as informações do veículo</p>
        </div>
    </div>
@endsection
...
@section('content')
    <div class="page-header">
        <h2 class="page-title">
            <i class="fas fa-car"></i> Editar Veículo
        </h2>
    ...
    <div class="admin-card">
        <div class="card-body">
            <form action="{{ route('admin.vehicles.update', $vehicle->id) }}" method="POST" class="admin-form">
                @csrf
                @method('PUT')
                    ...
                    <div class="form-group">
                        ...
                        @if($vehicle->photo)
                            <div class="image-preview">
                                <img src="{{ $vehicle->photo }}" alt="Preview" id="photoPreview">
                            </div>
                        @endif
...
<script>
    ...
    // Preview da imagem quando a URL mudar
