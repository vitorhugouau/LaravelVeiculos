...
@section('title', 'Nova Marca - Admin')

@section('hero')
    <div class="hero-section">
        <div class="hero-content">
            <h1 class="hero-title">
                <i class="fas fa-plus-circle"></i> Nova Marca
            </h1>
            <p class="hero-subtitle">Adicione uma nova marca ao sistema</p>
        </div>
    </div>
@endsection
...
@section('content')
    <div class="page-header">
        <h2 class="page-title">
            <i class="fas fa-tag"></i> Cadastrar Marca
        </h2>
