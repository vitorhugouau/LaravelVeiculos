...
@section('hero')
    <div class="hero-section">
        <div class="hero-content">
            ...
            <p class="hero-subtitle">Atualize as informações da marca</p>
        </div>
    </div>
@endsection
...
@section('content')
    <div class="page-header">
        <h2 class="page-title">
            <i class="fas fa-tag"></i> Editar Marca
        </h2>
    ...
    <div class="admin-card">
        <div class="card-body">
            <form action="{{ route('admin.brands.update', $brand->id) }}" method="POST" class="admin-form">
                @csrf
                @method('PUT')

                <div class="form-group">
                    <label for="name" class="form-label">
                        <i class="fas fa-tag"></i> Nome da Marca *
                    </label>
                    <input type="text" 
